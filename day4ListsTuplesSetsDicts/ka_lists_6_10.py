...
# print('8. Сдвинь список на 1 элемент вправо (циклический сдвиг).') # [1, 2, 3] > [3, 1, 2] карусель или очередь ходов
# def move_element(list_length):
#     randon_list = generate_list_with_random_values(list_length)
#     print(f'List: {randon_list}') # [1, 2, 3, 4]
#     shifted = randon_list[-1:] + randon_list[:-1] # = [4] + [1, 2, 3] = [4, 1, 2, 3]
#     return shifted
#
...
#     first_list.extend(second_list) #  first_list mutates, equivalent +=, BUT first_list + second_list =  new list
...
n = int(input('Enter length of the list N: '))
even, odd = split_list_to_even_odd(n) #unpacking
print("Чётные:", even)
print("Нечётные:", odd)
